...
public class test1 {
    ...
    public void testtest() {
        Page<Paper> papers = paperservice.searchpaper("改革", 0, 20, 0);
        System.out.println(papers.getSort());
    ...
    public void authorsearchtest() {
        Page<Author> authors = authorservice.searchauthor("computer", 0, 10, 0);
        int k=0;
        for(Author author:authors){
    ...
    public void testcount(){
        ...
        System.out.println(paperservice.findall());
    }
    }
